...
def main():
    """ This calls all relevant functions for running time complexity analysis on the algorithms,
        prompts for input regarding what representation of times is desired
    """
